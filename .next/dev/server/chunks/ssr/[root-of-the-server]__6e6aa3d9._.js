...
;
const metadata = {
    title: "SplitSmart - Split Group Expenses Fairly",
    description: "A modern expense-splitting app for friends, roommates, and trips. Split bills fairly with SplitSmart.",
    generator: "v0.app",
    icons: {
        icon: [
            {
